    ...
    <tbody><tr><td><div class="inline-flex"><span class="label label-success">Required</span> 
        ...
        <tr><td><div class="inline-flex"><span class="label label-warning">Optional</span> 
            ...
            <th width="60%">Description</th></tr>`,fe=p(),ee=s("tbody"),$=s("tr"),te=s("td"),te.textContent="expand",me=p(),ae=s("td"),ae.innerHTML='<span class="label">String</span>',_e=p(),f=s("td"),ve=v(`Auto expand record relations. Ex.:\r
                ...
                `),le=s("code"),le.textContent="expand",Se=v(" property (eg. "),oe=s("code"),oe.textContent='"expand": {"relField1": {...}, ...}',ye=v(`).\r
                `),Oe=s("br"),Re=v(`\r
